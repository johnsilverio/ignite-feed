...
const posts = [
	{
		...
		content: [
			...
			{ type: "hastag", content: "#nl" },
			{ type: "hastag", content: "#rocketseat" }, // Implementar na mesma linha...
		],
	...
	},
	{
		...
		content: [
			...
			{ type: "hastag", content: "#frontend" },
			{ type: "hastag", content: "#nextjs" },
			{ type: "hastag", content: "#typescript" },
			{ type: "hastag", content: "#musicapp" },
		],
